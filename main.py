...
def variant_game(user_choice: int):
    ...
    if user_choice == computer_choice:
        return f'Ничья, Борис выбрал {variant[computer_choice]}'
    
    elif user_choice == 1 and computer_choice == 2 \
        or user_choice == 2 and computer_choice == 3 \
            or user_choice == 3 and computer_choice == 1:
        return f"Вы выйграли, Борис выбрал {variant[computer_choice]}"
    
    elif user_choice == 1 and computer_choice == 3 \
        or user_choice == 2 and computer_choice == 1 \
            or user_choice == 3 and computer_choice == 2:
        return f'Вы проигали, Борис выбрал {variant[computer_choice]}'
